...
describe("findAll", function () {
  ...
  test('works with name and minEmployees filters', async function () {
  ...
  test('returns 400 if minEmployees > maxEmployees', async function () {
    try {
  ...
  test('returns empty array if no companies match the filters', async function () {
    let companies = await Company.findAll({ name: 'XYZ' });
    expect(companies).toEqual([]);
  });

  // Add more test cases for different combinations of filters and edge cases
